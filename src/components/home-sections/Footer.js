  ...
  return (
    <div className="footer">
      <div className="footer-1">
        <img
          width="230px"
          src="https://i.ibb.co/9HBXWc5/logo.png"
          alt="footer-logo"
        />
      ...
      <div className="mt-3">
        <p className="footer-txt-font">Quick Links</p>
      ...
      <div className="mt-3">
        <p className="footer-txt-font">Contract Us</p>
